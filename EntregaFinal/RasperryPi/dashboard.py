...
def on_message(client, userdata, msg):
    try:
        ...
        if all(k in j for k in ("rpm","spd","gear")):
            rpm_data.append(j["rpm"])
            vel_lineal_data.append(j["spd"])
            gear_data.append(j["gear"])
